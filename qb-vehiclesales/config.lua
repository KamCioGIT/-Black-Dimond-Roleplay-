...
Config.Zones = {
    ["SandyOccasions"] = {
        ...
        SellVehicle = vector4(-31.7, -1678.71, 29.46, 313.39),
        BuyVehicle = vector4(-43.94, -1676.27, 29.4, 46.55),

        PolyZone = {
            vector2(-65.5, -1687.31),
            vector2(-23.09, -1635.98),
            vector2(10.02, -1672.86),
            vector2(-53.95, -1700.14)
        },
        MinZ = 28.4,
        MaxZ = 30.4,
        ...
        VehicleSpots = {
           --[[ vector4(1237.07, 2699, 38.27, 1.5),
            ...
            vector4(-41.8, -1688.98, 28.39,200.36 ),
            vector4(-45.09, -1690.36, 28.38,202.41 ),
            vector4(-48.6, -1691.82, 28.45,200.67 ),
            vector4(-51.56, -1693.19, 28.49,201.59 ),
            vector4(-51.39, -1677.5, 28.4,51.91 ),
            vector4(-53.53, -1680.15, 28.48,52.62 ),
            vector4(-55.72, -1683.0, 28.48,52.11 ),
            vector4(-58.01, -1685.63, 28.48,49.75 ),
            vector4(-60.42, -1688.35, 28.48,47.98 ),
        }
    }
}
