...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 500, bank = 6000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 4.6 -- Rate at which hunger goes down.
...
QBConfig.Server.Discord = "https://discord.gg/alphatownbd" -- Discord invite link
