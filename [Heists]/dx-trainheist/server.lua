...
discord = {
    ['webhook'] = 'WEBHOOKLINK',
    ['name'] = 'rm_trainheist',
    ['image'] = 'https://cdn.discordapp.com/avatars/=/dea34d25f883049a798a241c8d94020c.png?size=1024'
}
...
QBCore.Functions.CreateCallback('trainheist:server:hasItem', function(source, cb, item)
    ...
    if player and playerItem ~= nil then
        ...
        TriggerClientEvent('QBCore:Notify', src, 'You need to have a pistol to continue', "error")
    end
end)
