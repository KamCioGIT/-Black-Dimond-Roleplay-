...
Config['TrainHeist'] = {
    ...
    ['reward'] = {
        itemName = 'uranium_cell', -- gold item name
        grabCount = 25, -- gold grab count
        sellPrice = 4000 -- buyer sell price
    },
...
Strings = {
    ...
    ['start_heist'] = 'Press ~INPUT_CONTEXT~ to Start Train Heist',
    ['goto_ambush'] = 'Go to ambush point in GPS. Kill the guards, search Merryweather containers and steal Uranium Cells.',
