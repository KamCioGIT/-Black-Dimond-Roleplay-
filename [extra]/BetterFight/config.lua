...
Config.Weapons= {
    ...
    [6] = { hash = `WEAPON_PISTOL50`, recoil = 3.80, rightLeftRecoil = 3.90, vehicleRecoil = 2.90, vehicleRightLeftRecoil = 2.50, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
   ...
   --EXTRA--
    ...
    [95] = { hash = `weapon_ak47`, recoil = 2.00, rightLeftRecoil = 2.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 1.20},
    ...
    [97] = { hash = `weapon_m1911`, recoil = 4.50, rightLeftRecoil = 3.55, vehicleRecoil = 1.50, vehicleRightLeftRecoil = 2.10, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.43},
    [98] = { hash = `weapon_glock22`, recoil = 4.90, rightLeftRecoil = 2.05, vehicleRecoil = 1.50, vehicleRightLeftRecoil = 2.30, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.45},
    ...
    [103] ={ hash = `weapon_uzi`, recoil = 3.00, rightLeftRecoil = 2.50, vehicleRecoil = 1.50, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 1.00},
    ...
    [105] ={ hash = `weapon_fnx45`, recoil = 5.00, rightLeftRecoil = 2.80, vehicleRecoil = 2.50, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.40},
    ...
    [107] ={ hash = `weapon_ak74`, recoil = 1.80, rightLeftRecoil = 1.80, vehicleRecoil = 1.50, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.65},
    ...
    [112] ={ hash = `weapon_glock17`, recoil = 4.50, rightLeftRecoil = 1.05, vehicleRecoil = 1.50, vehicleRightLeftRecoil = 2.30, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.55},
...
--V3 Guns--
    ...
    --Legendary--
    [115] ={ hash = `weapon_neva`, recoil = 0.30, rightLeftRecoil = 1.40, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.35},
    [116] ={ hash = `weapon_hfsmg`, recoil = 0.55, rightLeftRecoil = 1.40, vehicleRecoil = 3.00, vehicleRightLeftRecoil = 7.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.30},
    [117] ={ hash = `weapon_sfak`, recoil = 0.30, rightLeftRecoil = 1.40, vehicleRecoil = 2.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.35},
    [118] ={ hash = `weapon_drh`, recoil = 0.30, rightLeftRecoil = 1.40, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.30},
    [119] ={ hash = `weapon_ars`, recoil = 0.30, rightLeftRecoil = 1.40, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.32},
    [120] ={ hash = `weapon_cfs`, recoil = 0.30, rightLeftRecoil = 1.40, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.35},

    --Epic--
    [121] ={ hash = `weapon_ue4`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.48},
    [122] ={ hash = `weapon_ms32`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.18},
    [123] ={ hash = `weapon_safak`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.30},
    [124] ={ hash = `weapon_fmr`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.30},
    [125] ={ hash = `weapon_sf2`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.48},
    [126] ={ hash = `weapon_m416p`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.22},
    [127] ={ hash = `weapon_sfrifle`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.28},
    [128] ={ hash = `weapon_nanite`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.25},
    [129] ={ hash = `weapon_jrbak`, recoil = 0.40, rightLeftRecoil = 1.50, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.25},

    --Rare--
    [130] ={ hash = `weapon_ak47s`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.23},
    [131] ={ hash = `weapon_g3_2`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.23},
    [132] ={ hash = `weapon_famasu1`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.22},
    [133] ={ hash = `weapon_fn42`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.22},
    [134] ={ hash = `weapon_sar`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.22},
    [135] ={ hash = `weapon_mza`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.23},
    [136] ={ hash = `weapon_galilar`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.22},
    [137] ={ hash = `weapon_h2smg`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.22},
    [138] ={ hash = `weapon_m133`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.25},
    [139] ={ hash = `weapon_sb4s`, recoil = 0.50, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.16},

    --Common--
    [140] ={ hash = `weapon_iar`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.19},
    [141] ={ hash = `weapon_g36`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.19},
    [142] ={ hash = `weapon_ak4k`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.24},
    [143] ={ hash = `weapon_m16a3`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.20},
    [144] ={ hash = `weapon_idw`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.24},
    [145] ={ hash = `weapon_aug`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.32},
    [146] ={ hash = `weapon_sunda`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.32},
    [147] ={ hash = `weapon_akmkh`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.24},
    [148] ={ hash = `weapon_sarb`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.28},
    [149] ={ hash = `weapon_arc15`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.19},
    [150] ={ hash = `weapon_bulldog`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.19},
    [151] ={ hash = `weapon_groza`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.32},
    [152] ={ hash = `weapon_arma1`, recoil = 0.55, rightLeftRecoil = 1.60, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.17},

    --PD Rifles--
    [153] ={ hash = `weapon_glock17`, recoil = 4.50, rightLeftRecoil = 1.05, vehicleRecoil = 1.50, vehicleRightLeftRecoil = 2.30, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.55},
    [154] ={ hash = `weapon_fn502`, recoil = 4.50, rightLeftRecoil = 1.05, vehicleRecoil = 1.50, vehicleRightLeftRecoil = 2.30, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.55},
    [155] ={ hash = `weapon_ar15`, recoil = 0.45, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
    [156] ={ hash = `weapon_m4`, recoil = 0.45, rightLeftRecoil = 1.55, vehicleRecoil = 1.00, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
    ...
    [164] ={ hash = `weapon_scarh`, recoil = 0.35, rightLeftRecoil = 1.45, vehicleRecoil = 1.50, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 1.20},
