...
AddEventHandler("okokBanking:DepositMoney", function(amount)
	...
	if amount <= playerMoney then
		...
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You have deposited "..amount.."€", 5000, 'success')
	else
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You don't have that much money on you", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:WithdrawMoney", function(amount)
	...
	if amount <= playerMoney then
		...
		TriggerClientEvent('okokBanking:updateTransactions', _source, xPlayer.PlayerData.money.bank, xPlayer.PlayerData.money.cash)
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You have withdrawn "..amount.."€", 5000, 'success')
	else
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You don't have that much money on the bank", 5000, 'error')
	end
end)
	...
	if xPlayer.PlayerData.citizenid ~= targetIdentifier then
		if amount <= playerMoney then
			...
			if xTarget ~= nil then
				...
				for i=1, #xPlayers, 1 do
				    ...
				    if xForPlayer.PlayerData.citizenid == targetIdentifier then
				    	...
				    	TriggerClientEvent('dx-notify:Alert', xPlayers[i], "BANK", "You have received "..amount.."€ from "..xPlayer.PlayerData.charinfo.firstname..' '..xPlayer.PlayerData.charinfo.lastname, 5000, 'success')
				    end
				end
				TriggerEvent('okokBanking:AddTransferTransaction', amount, xTarget, _source)
				TriggerClientEvent('okokBanking:updateTransactions', _source, xPlayer.PlayerData.money.bank, xPlayer.PlayerData.money.cash)
				TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You have transferred "..amount.."€ to "..xTarget.PlayerData.charinfo.firstname..' '..xTarget.PlayerData.charinfo.lastname, 5000, 'success')
			elseif xTarget == nil then
				...
				TriggerClientEvent('okokBanking:updateTransactions', _source, xPlayer.PlayerData.money.bank, xPlayer.PlayerData.money.cash)
				TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You have transferred "..amount.."€ to "..targetName, 5000, 'success')
		...
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You can't send money to yourself", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:DepositMoneyToSociety", function(amount, society, societyName)
	...
	if amount <= playerMoney then
		...
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You have deposited "..amount.."€ to "..societyName, 5000, 'success')
	else
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You don't have that much money on you", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:WithdrawMoneyToSociety", function(amount, society, societyName, societyMoney)
	...
	if amount <= db.value then
		if db.is_withdrawing == 1 then
			TriggerClientEvent('dx-notify:Alert', _source, "BANK", "Someone is already withdrawing", 5000, 'error')
		else
			...
			TriggerClientEvent('okokBanking:updateTransactionsSociety', _source, xPlayer.PlayerData.money.cash)
			TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You have withdrawn "..amount.."€ from "..societyName, 5000, 'success')
		end
	else
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "Your society doesn't have that much money on the bank", 5000, 'error')
	end
...
AddEventHandler("okokBanking:TransferMoneyToSociety", function(amount, ibanNumber, societyName, society)
	...
	local playerMoney = xPlayer.PlayerData.money.bank
		...
		if amount <= playerMoney then
			...
			TriggerClientEvent('okokBanking:updateTransactionsSociety', _source, xPlayer.PlayerData.money.cash)
			TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You have transferred "..amount.."€ to "..societyName, 5000, 'success')
		else
			TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You don't have that much money on the bank", 5000, 'error')
		end
end)
...
AddEventHandler("okokBanking:TransferMoneyToSocietyFromSociety", function(amount, ibanNumber, societyNameTarget, societyTarget, society, societyName, societyMoney)
	...
	if amount <= societyMoney then
		...
		TriggerClientEvent('okokBanking:updateTransactionsSociety', _source, xPlayer.PlayerData.money.cash)
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You have transferred "..amount.."€ to "..societyNameTarget, 5000, 'success')
	else
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "Your society doesn't have that much money on the bank", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:UpdateIbanDB", function(iban, amount)
	...
	if amount <= xPlayer.PlayerData.money.bank then
		...
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "IBAN successfully changed to "..iban, 5000, 'success')
	else
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You need to have "..amount.."€ in order to change your IBAN", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:UpdatePINDB", function(pin, amount)
	...
	if amount <= xPlayer.PlayerData.money.bank then
		...
		TriggerClientEvent('okokBanking:updateIbanPinChange', _source)
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "PIN successfully changed to "..pin, 5000, 'success')
	else
		TriggerClientEvent('dx-notify:Alert', _source, "BANK", "You need to have "..amount.."€ in order to change your PIN", 5000, 'error')
	end
end)