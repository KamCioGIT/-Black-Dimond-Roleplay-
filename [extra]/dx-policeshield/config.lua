...
translations = {
    noArguments = "You must specify the shield type",
    invalidShieldType = "You must specify the shield type",
    outsideVehicle = "You must be outside a vehicle",
    shieldRemoved = "Shield removed",
}
