...
Citizen.CreateThread(function()
    Wait(500)
    QBCore.Functions.TriggerCallback('dx-moneywash:server:GetData', function(data)
                    ...
                    if not washing and not collect then      
                        DrawText3Ds(washLocations.pOne.x, washLocations.pOne.y, washLocations.pOne.z, "~g~E~w~ - Start Washer")
                            if IsControlJustReleased(1, Keys['E']) then
                                ...
                                TriggerServerEvent('dx-moneywash:server:checkInv', amt)
...
RegisterNetEvent('dx-moneywash:client:washTimer')
AddEventHandler('dx-moneywash:client:washTimer', function()
        Citizen.Wait(0)
        local pos = GetEntityCoords(PlayerPedId())
        local ped = PlayerPedId()
        local inRange = false
                ...
                if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, collectCoordX,collectCoordY, collectCoordZ, true) < 0.5 then      
                        if IsControlJustReleased(1, Keys['E']) and inRange then
                            ...
                            flags = 16,
                                ...
                                TriggerServerEvent('dx-moneywash:server:giveMoney', amt)
...
RegisterNetEvent('dx-moneywash:client:startTimer')
AddEventHandler('dx-moneywash:client:startTimer', function(amt)
    ...
    TriggerEvent('dx-moneywash:client:washTimer')
