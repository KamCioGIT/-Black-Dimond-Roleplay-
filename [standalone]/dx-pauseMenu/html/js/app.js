var discordURL = "https://discord.gg/eHEx4jpAac";
var instagramURL = "https://www.instagram.com";
var youtubeURL = "https://www.youtube.com/@dx_fivem";
...
$(document).on("click", ".wrapperItems", function () {
    ...
    if (selectedDiv == "discordItem") {
        ...
        $.post("https://dx-pauseMenu/openSettings", JSON.stringify());
        $(".pauseGeneral").hide();
    } else if (selectedDiv == "resumeItem") {
        $.post("https://dx-pauseMenu/closeMenu", JSON.stringify());
        $(".pauseGeneral").hide();
    } else if (selectedDiv == "mapItem") {
        $.post("https://dx-pauseMenu/openMap", JSON.stringify());
        $(".pauseGeneral").hide();
...
$(document).on("click", "#exitButton", function () {
    $.post("https://dx-pauseMenu/exit", JSON.stringify());
});
