...
local animations = {
    ...
    { dict = "anim@amb@nightclub@dancers@crowddance_groups_transitions@from_low_intensity", anim = "trans_dance_crowd_li_to_hi_09_v1_female^6"},
        --[[لا تحاول تشيل الحقوق , الله ما يحلل الشئ الغير حلال]]
    ...
    { dict = "anim@amb@nightclub@dancers@crowddance_groups_transitions@from_med_intensity", anim = "trans_dance_crowd_mi_to_li_09_v2_male^4"},        --[[لا تحاول تشيل الحقوق , الله ما يحلل الشئ الغير حلال]]
...
RegisterCommand('dances', function(source, args, raw) -- هذا الكوماند لو تبي تغيره
    if args[1] ~= nil then
...
RegisterNetEvent("police:currentHandCuffedState") -- هذا التريقر إيفنت حق سكربت الشرطة حقك انه ما يقدر يسوي اي حركة اذا مكلبش
