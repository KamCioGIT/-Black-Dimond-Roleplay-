Config = {
	...
	System = {
		...
		img = "qs-inventory/html/images/", 	-- Set this to the directory for your inventory image files
											-- "ox_inventory/web/images/", "qs-inventory/html/images", "lj-inventory/html/images"
		Inv = "qb",  				-- "qb", "ox", "qs"
		Menu = "qb",  				-- "qb", "ox"
		Notify = "qb",				-- "qb", "ox"
		...
		RenewedBanking = enable, 	-- This is used for manualrepair benches, enable to use
	},
	Main = { -- Main variables
	...
	Emergency = {
		...
		Locations = {
			{ coords = vec4(445.55, -986.75, 25.14, 178.09), prop = true, }, -- MRPD UNDERGROUND PARKING
			{ coords = vec4(378.58, -572.77, 28.83, 180.05), prop = true, }, -- PILL BOX GARAGE
		},
