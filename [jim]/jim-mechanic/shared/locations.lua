...
Config.Locations[#Config.Locations+1] = { -- [[LS CUSTOMS ROUTE 68]] --
	...
	stash = {
		{ coords = vec4(-350.44, -132.11, 42.04, 162.55), w = 3.2, d = 1.0 },
	},
	store = {
		{ coords = vec4(-362.49597167969, -98.407241821289, 39.546619415283, 249.4010925293), w = 4.2, d = 3.6 },
	},
	crafting = {
		{ coords = vec4(-328.42184448242, -165.7989654541, 39.009510040283, 195.7785949707), w = 3.0, d = 1.2 },
	},
	clockin = {
