...
Config.MaxInventoryWeight = 500000 -- Max weight a player can carry (default 120kg, written in grams)
Config.MaxInventorySlots = 100 -- Max inventory slots for a player
