...
* [qs-inventory](https://github.com/qbcore-framework/qs-inventory) follow instructions below. 
...
```
        elseif QBCore.Shared.SplitStr(shopType, "_")[1] == "Itemshop" then
            if Player.Functions.RemoveMoney("cash", price, "itemshop-bought-item") then
                ...
                local imageurl = ("https://cfx-nui-qs-inventory/html/images/%s.png"):format(itemData.name)
