...
Config['HumaneLabs'] = {
    ...
    ['rewards'] = {
        ...
        ['items'] = { -- you can disable this, just make ['items'] = nil
            { name = 'goldbar', count = function() return math.random(1, 5) end},
            { name = 'cryptostick', count = function() return math.random(1, 3) end}
        }
    },
    ['minigameDifficulty'] = {
        ['selected'] = 'hard',
    ...
    ['startHeist'] ={ -- heist start coords
        pos = vector3(284.86, -2918.11, 5.5),
        peds = {
            {pos = vector3(286.56, -2917.98, 5.63), heading = 110.22, ped = 's_m_m_highsec_01'},
            {pos = vector3(285.63, -2919.58, 5.71), heading = 200.78, ped = 's_m_m_highsec_02'},
            {pos = vector3(283.34, -2918.72, 5.45), heading = 5.42, ped = 's_m_m_fiboffice_02'}
        }
    },
    ['middleHeist'] = {
        peds = {
