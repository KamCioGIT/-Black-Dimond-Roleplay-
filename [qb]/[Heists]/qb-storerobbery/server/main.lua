...
local cashB = 10000				--<< how much maximum you can get from a robbery
...
RegisterNetEvent('qb-storerobbery:server:callCops', function(type, safe, streetLabel, coords)
    ...
    local alertData = {
        ...
        description = "Someone Is Trying To Rob A Store At "..streetLabel.." (CAMERA ID: "..camId..")"
    }
    TriggerClientEvent("qb-storerobbery:client:robberyCall", -1, type, safe, streetLabel, coords, camId)
