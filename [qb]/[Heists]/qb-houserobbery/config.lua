...
Config.Rewards = {
    [1] = {
        ["cabin"] = {"plastic", "diamond_ring", "goldchain", "weed_skunk", "thermite", "cryptostick", "weapon_golfclub", "bluechip" },
        ["kitchen"] = {"greenchip", "sandwich", "goldchain"},
        ["chest"] = {"greenchip", "cryptostick", "weapon_combatpistol", "redchip"},
        ["livingroom"] = {"diamond_ring", "redchip", "bluechip", "cryptostick", "tablet",}
    }
}
