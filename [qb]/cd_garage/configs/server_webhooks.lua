...
local ExploitLogWebhook = 'https://discord.com/api/webhooks/1121636507753660457/nOyDIUtKxFUQ1Jh1hvPrl6yJivqOCYIozbevTNFep4QJPzDGJfPonq6TNTIdFjgwGEVo' --If a player is found using cheat engine to change the hash of a vehicle, this will send a message on discord and kick them from the game.
local ImpoundLogWebhook = 'https://discord.com/api/webhooks/1121636507753660457/nOyDIUtKxFUQ1Jh1hvPrl6yJivqOCYIozbevTNFep4QJPzDGJfPonq6TNTIdFjgwGEVo' --When a player impounds/unimpounds a vehicle.
local TransferVehicleLogWebhook = 'https://discord.com/api/webhooks/1121636507753660457/nOyDIUtKxFUQ1Jh1hvPrl6yJivqOCYIozbevTNFep4QJPzDGJfPonq6TNTIdFjgwGEVo' --When a player transfers a vehicle to another player.
local VehicleManagementLogWebhook = 'https://discord.com/api/webhooks/1121636507753660457/nOyDIUtKxFUQ1Jh1hvPrl6yJivqOCYIozbevTNFep4QJPzDGJfPonq6TNTIdFjgwGEVo' --When a staff member uses the vehicle managment commands.
local GarageSpaceLogWebhook = 'https://discord.com/api/webhooks/1121636507753660457/nOyDIUtKxFUQ1Jh1hvPrl6yJivqOCYIozbevTNFep4QJPzDGJfPonq6TNTIdFjgwGEVo' --When a player sells a garage slot.
...
function VehicleManagmentLogs(source, action, plate, target, garage_type)
    if VehicleManagementLogWebhook ~= 'https://discord.com/api/webhooks/1121636507753660457/nOyDIUtKxFUQ1Jh1hvPrl6yJivqOCYIozbevTNFep4QJPzDGJfPonq6TNTIdFjgwGEVo' and VehicleManagementLogWebhook ~= nil then
        local message, color
        if action == 'add' then
