...
local function ItemsToItemInfo()
	itemInfos = {
		...
		[5] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 100x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 150x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 50x, "..QBCore.Shared.Items["iron"]["label"] .. ": 120x, "..QBCore.Shared.Items["electronickit"]["label"] .. ": 2x."},
        ...
        [13] = {costs = QBCore.Shared.Items["iron"]["label"] .. ": 80x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 120x, "..QBCore.Shared.Items["copper"]["label"] .. ": 50x, "..QBCore.Shared.Items["rubber"]["label"] .. ": 2x."},
        [14] = {costs = QBCore.Shared.Items["iron"]["label"] .. ": 80x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 120x, "..QBCore.Shared.Items["copper"]["label"] .. ": 50x, "..QBCore.Shared.Items["rubber"]["label"] .. ": 2x."},
    }
