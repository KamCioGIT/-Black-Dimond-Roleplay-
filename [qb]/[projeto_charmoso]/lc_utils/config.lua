...
Config.custom_scripts_compatibility = {
	['fuel'] = "cdn-fuel",						-- [ox_fuel|ps-fuel|LegacyFuel|default|other] Fuel script Compatibility
	['inventory'] = "default",					-- [ox_inventory|qs-inventory|ps-inventory|default|other] Inventory script Compatibility
	['keys'] = "cd_garage",						-- [qs-vehiclekeys|cd_garage|jaksam|default|other] Keys script Compatibility
