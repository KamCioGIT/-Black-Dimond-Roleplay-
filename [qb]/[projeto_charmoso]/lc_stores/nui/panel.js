	...
	if (item.price){
		...
		if (item.isMarket) {
			...
			*/
			...
			$('#profile-money-earned').append(Utils.currencyFormat(store_business.total_money_earned));
			$('#profile-money-spent').empty();
			$('#profile-money-spent').append(Utils.currencyFormat(store_business.total_money_spent));
			$('#profile-goods').empty();
			$('#profile-goods').append(Utils.numberFormat(store_business.goods_bought));
			$('#profile-distance-traveled').empty();
			$('#profile-distance-traveled').append(Utils.numberFormat(store_business.distance_traveled) + 'km');
			$('#profile-total-visits').empty();
			$('#profile-total-visits').append(Utils.numberFormat(store_business.total_visits));
			$('#profile-customers').empty();
			$('#profile-customers').append(Utils.numberFormat(store_business.customers));
			...
			$('#profile-stock-2').append(Utils.translate('statistics_page_stock').format(store_business.stock_amount,stock_capacity));
			$('#profile-stock-variety').empty();
			$('#profile-stock-variety').append(Utils.translate('statistics_page_stock_variety').format(store_business.stock_variety.toFixed(1)));
			...
			`);
			$('#stock-filter-statistics').empty();
			$('#stock-filter-statistics').append(`
			...
			*/
			...
			for (const categoryIdx of config.market_categories_to_buy ) {
			...
			*/
			...
			if(item.update != true){
				...
				$('#main-page-title').append(Utils.translate('statistics_page_title'));
				$('#main-page-desc').empty();
				$('#main-page-desc').append(Utils.translate('statistics_page_desc'));
				$('#profile-money-earned-2').empty();
				$('#profile-money-earned-2').append(Utils.translate('statistics_page_money_earned'));
				$('#profile-money-spent-2').empty();
				$('#profile-money-spent-2').append(Utils.translate('statistics_page_money_spent'));
				$('#profile-goods-2').empty();
				$('#profile-goods-2').append(Utils.translate('statistics_page_goods'));
				$('#profile-distance-traveled-2').empty();
				$('#profile-distance-traveled-2').append(Utils.translate('statistics_page_distance_traveled'));
				$('#profile-total-visits-2').empty();
				$('#profile-total-visits-2').append(Utils.translate('statistics_page_total_visits'));
				$('#profile-customers-2').empty();
				$('#profile-customers-2').append(Utils.translate('statistics_page_customers'));
				...
				$('#goods-page-title').append(Utils.translate('goods_page_title'));
				$('#goods-page-desc').empty();
				$('#goods-page-desc').append(Utils.translate('goods_page_desc'));
	
				// Hire page
				$('#hire-page-title').empty();
				$('#hire-page-title').append(Utils.translate('hire_page_title'));
				$('#hire-page-desc').empty();
				$('#hire-page-desc').append(Utils.translate('hire_page_desc'));
				
				// Upgrades page
				$('#upgrades-page-title').empty();
				$('#upgrades-page-title').append(Utils.translate('upgrades_page_title'));
				$('#upgrades-page-desc').empty();
				$('#upgrades-page-desc').append(Utils.translate('upgrades_page_desc'));
				...
				//categories page
				$('#categories-page-title').empty();
				$('#categories-page-title').append(Utils.translate('categories_page_title'));
				$('#categories-page-desc').empty();
				$('#categories-page-desc').append(Utils.translate('categories_page_desc'));
