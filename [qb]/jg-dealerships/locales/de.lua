...
Locales['de'] = {
  ...
  vehiclesCount = "Fahrzeuge Zahl",
  dealersCount = "Händler",
  accountBalance = "Konto Balance",
  bank = "Bankkonto",
  cash = "Bargeld",
  amount = "Betrag",
  ...
  deleteConfirmationDanger = "löschen Bestätigungs Nicht Rückgängig.",
  ...
  importBehaviour = "Import Verhaltensweisen",
  ...
  errorVehicleWithSpawnCodeExists = "Ein Fahrzeug mit diesem Spawncode existiert bereits!",
