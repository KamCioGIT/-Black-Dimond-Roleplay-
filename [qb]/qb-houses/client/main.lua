...
RegisterCommand('createhouse', function()
    ...
    if job == 'realestate' then
        local dialog = exports['qb-input']:ShowInput({
            header = "Create House",
            submitText = "Create New House",
            inputs = {
                {
                    text = "House Price ($)", -- text you want to be displayed as a place holder
                    name = "price", -- name of the input should be unique otherwise it might override
                    type = "text", -- type of the input
                    isRequired = true -- Optional [accepted values: true | false] but will submit the form if no value is inputted
                },
                {
                    text = "House Tier", -- text you want to be displayed as a place holder
                    name = "tier", -- name of the input should be unique otherwise it might override
                    ...
                    options = { -- Select drop down options, the first option will by default be selected
                        { value = "1", text = "Tier 1" }, -- Options MUST include a value and a text option
                        { value = "2", text = "Tier 2" },
                        { value = "3", text = "Tier 3" }, 
                        { value = "4", text = "Caravan Shell" },
                        { value = "5", text = "Lester Shell" },
                        { value = "6", text = "Tier 6" },
                        { value = "7", text = "Franklins Aunt House" }, 
                        { value = "8", text = "Tier 8" }, 
                        { value = "9", text = "Filthy Place" }, 
                        --{ value = "16", text = "Filthy Place" }, 
                        { value = "17", text = "Tier 17" }, 
                        { value = "18", text = "Tier 18" }, 
                        { value = "19", text = "Tier 19" }, 
                        { value = "20", text = "Tier 20" }, 
                        { value = "21", text = "Tier 21" },
                        { value = "25", text = "Garages - 1" },
                        { value = "26", text = "Garages - 2" },
                        { value = "27", text = "Garages - 3" },
                        { value = "28", text = "Offices - 1" },
                        { value = "29", text = "Offices - 2" },
                        { value = "30", text = "Offices - 3" },
                        { value = "31", text = "Barber Shop" },
                        { value = "32", text = "Gun Store" },
                        { value = "33", text = "Shops - 1" },
                        { value = "34", text = "Shops - 2" },
                        { value = "35", text = "Shops - 3" },
                        { value = "54", text = "Coke Production Plant - 1" },
                        { value = "55", text = "Coke Production Plant - 2" },
                        { value = "56", text = "Meth Production Plant" },
                        { value = "57", text = "Weed Production Plant - 1" },
                        { value = "58", text = "Weed Production Plant - 2" }
                    }
                }
            },
        })
        ...
        street = street:gsub("%-", " ")
        TriggerServerEvent('qb-houses:server:addNewHouse', street, coords, price, tier)
        --TriggerEvent("qb-houses:client:createHouses", source, price, tier)
    else
