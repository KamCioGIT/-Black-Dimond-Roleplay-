...
RegisterNetEvent('consumables:client:EcstasyBaggy', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Smells Like Something Scary", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
RegisterNetEvent('consumables:client:EcstasyBaggy1', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Smells Like Something Scary", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        StopAnimTask(PlayerPedId(), "mp_suicide", "pill", 1.0)
        TriggerServerEvent("QBCore:Server:RemoveItem", "spicebaggy", 1)
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["spicebaggy"], "remove")
        EcstasyEffect()
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "mp_suicide", "pill", 1.0)
        QBCore.Functions.Notify("Failed", "error")
...
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
RegisterNetEvent('consumables:client:EcstasyBaggy2', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Smells Like Something Scary", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
...
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
RegisterNetEvent('consumables:client:EcstasyBaggy3', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Smells Like Something Scary", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        StopAnimTask(PlayerPedId(), "mp_suicide", "pill", 1.0)
        TriggerServerEvent("QBCore:Server:RemoveItem", "marijuana", 1)
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["marijuana"], "remove")
        EcstasyEffect()
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "mp_suicide", "pill", 1.0)
        QBCore.Functions.Notify("Failed", "error")
...
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
RegisterNetEvent('consumables:client:EcstasyBaggy4', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Smells Like Something Scary", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
...
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
RegisterNetEvent('consumables:client:EcstasyBaggy5', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Smells Like Something Scary", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
...
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
RegisterNetEvent('consumables:client:EcstasyBaggy6', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Smells Like Something Scary", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        StopAnimTask(PlayerPedId(), "mp_suicide", "pill", 1.0)
        TriggerServerEvent("QBCore:Server:RemoveItem", "lsa", 1)
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["lsa"], "remove")
        EcstasyEffect()
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "mp_suicide", "pill", 1.0)
        QBCore.Functions.Notify("Failed", "error")
