...
Config.miner = {
	['BossSpawn'] = { 
        ...
        --vector4(2569.75, 2719.92, 42.92, 215.82)
        Pos = {x = 2569.75, y = 2719.92, z = 42.92, h = 215.82},
    ...
    ['Sell'] = {
        --vector4(2682.16, 2760.57, 37.88, 301.35)
        --Pos = {x = 2942.72, y = 2742.89, z = 43.35, h = 312.74},
        Pos = {x = 2682.16, y = 2760.57, z = 37.88, h = 301.35},
        Type  = 'a_m_m_fatlatin_01', --model ped
    },
}
...
Config.Pickaxe = {
    ...
    [2] = {name = 'copper', color = '~o~', price = 20000},
    [3] = {name = 'stone', color = '~c~', price = 30000},
    [4] = {name = 'gold', color = '~y~', price = 50000},
    [5] = {name = 'silver', color = '~c~', price = 60000},
    [6] = {name = 'iron', color = '~w~', price = 80000},
    [7] = {name = 'diamond', color = '~b~', price = 100000},
}
