 ...
 Config.Locations = {
     ...
     ['customs'] = {
        settings = {
            ...
            welcomeLabel = "Welcome to Los Santos Customs!",
            enabled = true,
        },
        blip = {
            label = 'Los Santos Customs',
            coords = vector3(-335.89, -131.77, 39.01),
            sprite = 72,
            scale = 0.65,
            color = 0,
            display = 4,
        ...
        zones = {
            { coords = vector3(-326.92, -144.35, 38.49), length = 6.0, width = 4.0, heading = 67.68, minZ = 38.0, maxZ = 39.0 },
            { coords = vector3(-323.31, -134.2, 38.49), length = 6.0, width = 4.0, heading = 69.91, minZ = 38.0, maxZ = 39.0 },
        }
    },
