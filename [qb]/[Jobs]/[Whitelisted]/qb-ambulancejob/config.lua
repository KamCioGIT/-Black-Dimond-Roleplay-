...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(306.98, -595.1, 43.28),
	    [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(312.32, -592.9, 43.28),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(292.38, -586.22, 43.19, 339.91),
        [2] = vector4(293.95, -574.08, 43.18, 61.11),
        [3] = vector4(284.46, -601.88, 43.18, 160.93),
        [4] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ["helicopter"] = {
        [1] = vector4(350.83, -588.36, 74.16, 151.74),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(310.01, -568.93, 43.28),
    ...
    ["main"] = {
        [1] = vector3(332.38, -595.79, 43.28),
    },
    ["stash"] = {
        [1] = vector3(301.9, -599.45, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(319.16, -581.11, 43.2, 168.22), taken = false, model = 1631638868},
        [2] = {coords = vector4(324.15, -583.06, 43.2, 148.66), taken = false, model = 1631638868},
        [3] = {coords = vector4(322.57, -587.5, 43.2, 332.16), taken = false, model = 2117668672},
        [4] = {coords = vector4(317.72, -585.48, 43.2, 336.65), taken = false, model = 2117668672},
        [5] = {coords = vector4(314.5, -584.22, 43.2, 330.75), taken = false, model = 2117668672},
        [6] = {coords = vector4(311.25, -583.03, 43.2, 339.82), taken = false, model = -1091386327},
        [7] = {coords = vector4(307.74, -581.86, 43.2, 332.27), taken = false, model = -1091386327},
        [8] = {coords = vector4(309.24, -577.13, 43.2, 151.94), taken = false, model = -1091386327},
        [9] = {coords = vector4(313.83, -579.01, 43.2, 161.41), taken = false, model = -1091386327},
    },
    ["stations"] = {
...
Config.AuthorizedVehicles = { -- Vehicles players can use based on their ambulance job grade level
	...
	[0] = {
       ...
       ["nhsskodavan"] = "Skoda Van",
       ["nhslondon"] = "Mercedes Black Ambulance",
       ["nhsford"] = "NHS Ford Paramedic",
       ["nhsbike"] = "NHS BMW Bike",
	},
	-- Grade 1
	[1] = {
		["nhsmercedes"] = "Mercedes Ambulance",
