		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Turbo", 5000, false, true, {
                    ...
                    local success = exports["taskbarskill"]:taskBar(3700, 1)
                    if success then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing A Stage 1 Transmission", 5000, false, true, {
                    ...
                    local success = exports["taskbarskill"]:taskBar(3700, 1) --StartLockPickCircle(1,10) 1= how many times, 30 = time in seconds
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
