...
RegisterNetEvent("qb-openfishing:tryToFish")
AddEventHandler("qb-openfishing:tryToFish", function()
	TryToFish() 
end)

RegisterNetEvent("qb-openfishing:calculatedistances")
AddEventHandler("qb-openfishing:calculatedistances", pos, function()
