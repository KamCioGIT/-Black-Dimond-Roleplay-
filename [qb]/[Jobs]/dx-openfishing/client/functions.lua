...
TryToFish = function()
    QBCore.Functions.TriggerCallback('qb-openfishing:GetItemData', function(count)
...
CastBait = function(rodHandle, castLocation)
    ...
    if caughtFish then
        TriggerServerEvent("qb-openfishing:receiveFish", castLocation, function(received) end)
...
SellFish = function()
    QBCore.Functions.TriggerCallback('qb-openfishing:GetItemData', function(count)
        ...
        TriggerServerEvent("qb-openfishing:sellFish", function(sold, fishesSold) end)
    end)
end
