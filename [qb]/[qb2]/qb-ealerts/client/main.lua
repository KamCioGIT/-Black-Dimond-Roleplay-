...
RegisterNetEvent('strez:client:SendMailAlertsBasic', function(text)
    ...
    TriggerServerEvent('qs-smartphone:server:sendNewMail', {
        sender = 'District of FiveM Store',
...
RegisterNetEvent('strez:client:SendMailTsunamiManualOverride', function(text)
    ...
    TriggerServerEvent('qs-smartphone:server:sendNewMail', {
        sender = 'District of FiveM Store',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for FiveM Storey, In 15 minutes! Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
    Wait(math.random(30000, 60000))
    TriggerServerEvent('qb-weathersync:server:setWeather', 'THUNDER')
...
RegisterNetEvent('strez:client:SendMailTsunamiAuto15', function(text)
        ...
        Wait(math.random(7000, 13000))
        TriggerServerEvent('qs-smartphone:server:sendNewMail', {
            sender = 'District of FiveM Storey',
            subject = 'Emergency Alert',
            message = 'The National Weather Service has issued a TSUNAMI WARNING for FiveM Storey, In 15 minutes! Please start heading home or somewhere local for SAFETY!',
            button = {}
        })
...
RegisterNetEvent('strez:client:SendMailTsunamiAuto5', function(text)
    ...
    TriggerServerEvent('qs-smartphone:server:sendNewMail', {
        sender = 'District of FiveM Storey',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for FiveM Storey, In 5 minutes! FiveM Storey is losing City Power, Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
...
RegisterNetEvent('strez:client:SendMailTsunamiAuto1', function(text)
    ...
    TriggerServerEvent('qs-smartphone:server:sendNewMail', {
        sender = 'District of FiveM Storey',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for FiveM Storey, In 1 minutes! Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
    Wait(math.random(13000, 23000))
    TsunamiEffect()
