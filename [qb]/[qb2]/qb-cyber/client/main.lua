...
Citizen.CreateThread(function()
MainJobBlip = AddBlipForCoord(335.74, -912.54, 29.25)
    SetBlipSprite(MainJobBlip, 775)
    SetBlipScale(MainJobBlip, 0.7)
    SetBlipColour(MainJobBlip, 44)
    SetBlipAsShortRange(MainJobBlip, true)
    SetBlipDisplay(MainJobBlip, 4)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Cyber Bar")
    EndTextCommandSetBlipName(MainJobBlip)
end)
