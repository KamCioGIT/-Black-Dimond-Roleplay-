...
exports['dx-ui']:Open('[Key] Message', 'color', 'position')
...
To make the text bold: exports['dx-ui']:Open('<b>[Key] Message</b>', 'color', 'position')
To insert multiple lines/commands in a text UI: exports['dx-ui']:Open('[Key] Message 1<br>[Key] Message 2', 'color', 'position')
	...
	while true do
		...
		if inZone and not shown then
			...
			if locked and hasAuth then
				exports['dx-ui']:Open('[E] Locked', 'lightred', 'left')
			elseif not locked and hasAuth then
				exports['dx-ui']:Open('[E] Unlocked', 'lightgreen', 'left')
			elseif locked then
				exports['dx-ui']:Open('Locked', 'lightred', 'left')
			else
				exports['dx-ui']:Open('Unlocked', 'lightgreen', 'left')
			end
