...
Config.BotName = 'Dx Shop' -- Write the desired bot name

Config.ServerName = 'NP QBCore' -- Write your server's name

Config.IconURL = 'https://cdn.discordapp.com/attachments/a/1005223832933642270/logo.png' -- Insert your desired image link
