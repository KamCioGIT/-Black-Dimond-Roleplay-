...
Config.BotToken = "MTE1ODA4MTYzNjkxMTU2Njk2OA.GIG4on.tDIa6lcy_f6NHXjk7QV3AdkfJWkHEonB1I83gY"
...
Config.Fish = {
    -- COMMON CATEGORY
    {itemname = 'bluegill',              xp = 30, name = 'Bluegill',                  sell = true, category = 'common',   price = 50},
    {itemname = 'goldentrout',           xp = 30, name = 'Golden Trout',              sell = true, category = 'common',   price = 50},
    {itemname = 'silverymonnow',         xp = 30, name = 'Silvery Monnow',            sell = true, category = 'common',   price = 50},
    {itemname = 'strippedbass',          xp = 30, name = 'Stripped Bass',             sell = true, category = 'common',   price = 50},
    {itemname = 'tench',                 xp = 30, name = 'Tench',                     sell = true, category = 'common',   price = 50},
    {itemname = 'whitefish',             xp = 30, name = 'White Fish',                sell = true, category = 'common',   price = 50},
    {itemname = 'crappie',               xp = 30, name = 'Crappie',                   sell = true, category = 'common',   price = 50},
    {itemname = 'cruciancarp',           xp = 30, name = 'Crucian Carp',              sell = true, category = 'common',   price = 50},
    -- UNCOMMON CATEGORY--------------   ------------------------------        ---------------------
    {itemname = 'bluebackherring',       xp = 40, name = 'Blueback Herring',         sell = true, category = "uncommon", price = 100},
    {itemname = 'bulltrout',             xp = 40, name = 'Bull Trout',               sell = true, category = "uncommon", price = 100},
    {itemname = 'laketrout',             xp = 40, name = 'Lake Trout',               sell = true, category = "uncommon", price = 100},
    {itemname = 'perch',                 xp = 40, name = 'Perch',                    sell = true, category = "uncommon", price = 100},
    {itemname = 'chub',                  xp = 40, name = 'Chub',                     sell = true, category = "uncommon", price = 100},
    {itemname = 'colorodopikeminnow',    xp = 40, name = 'Colorodo Pike Minnow',     sell = true, category = "uncommon", price = 100},
    {itemname = 'drumfish',              xp = 40, name = 'Drum Fish',                sell = true, category = "uncommon", price = 100},
    {itemname = 'wallaye',               xp = 40, name = 'Walleye',                  sell = true, category = "uncommon", price = 100},
    -- RARE CATEGORY------------------   ------------------------------        ----------------------
    {itemname = 'americanshad',          xp = 50, name = 'American Shad',            sell = true, category = "rare",     price = 300},
    {itemname = 'palidsturgeon',         xp = 50, name = 'Palid Sturgeon',           sell = true, category = "rare",     price = 300},
    {itemname = 'pike',                  xp = 50, name = 'Pike',                     sell = true, category = "rare",     price = 300},
    {itemname = 'blackcrappie',          xp = 50, name = 'Black Crappie',            sell = true, category = "rare",     price = 300},
    {itemname = 'bream',                 xp = 50, name = 'Bream',                    sell = true, category = "rare",     price = 300},
    {itemname = 'brooktrout',            xp = 50, name = 'Brook Trout',              sell = true, category = "rare",     price = 300},
    {itemname = 'shortnosesucker',       xp = 50, name = 'Shortnose Sucker',         sell = true, category = "rare",     price = 300},
    {itemname = 'smallmouthbass',        xp = 50, name = 'Smallmouth Bass',          sell = true, category = "rare",     price = 300},
    --LEGENDARY CATEGORY --
    {itemname = 'arowana',               xp = 60, name = 'Arowana',                  sell = true, category = "legendary",price = 400},
    {itemname = 'sweetfish',             xp = 60, name = 'Sweetfish',                sell = true, category = "legendary",price = 400},
    {itemname = 'whitebass',             xp = 60, name = 'White Bass',               sell = true, category = "legendary",price = 400},
    {itemname = 'alabamasturgeon',       xp = 60, name = 'Alabama Sturgeon',         sell = true, category = "legendary",price = 400},
    --EPIC CATEGORY --
    {itemname = 'lakesturgeon',          xp = 70, name = 'Lake Sturgeon',            sell = true, category = "epic",     price = 500},
    {itemname = 'koicarpblack',          xp = 70, name = 'Koi Carp Black',           sell = true, category = "epic",     price = 500},
    {itemname = 'lahontancutthroattrout',xp = 70, name = 'Lahontan Cutthroat Trout', sell = true, category = "epic",     price = 500},
    ...
    {itemname = 'threesidedbait',   baitLevel = 2,  fishQualityScale = {'uncommon'}, sell = false, name = 'Three Sided Bait', category = "baits", price = 30, stars = 2, baitsuse = true},
    {itemname = 'tailfishbait',     baitLevel = 3,  fishQualityScale = {'rare'},     sell = false, name = 'Tail Fish Bait',   category = "baits", price = 35, stars = 3, baitsuse = true},
    {itemname = 'doublehookbait',   baitLevel = 4,  fishQualityScale = {'legendary'},sell = false, name = 'Double Hook Bait', category = "baits", price = 40, stars = 4, baitsuse = true},
    {itemname = 'triplehooksbait',  baitLevel = 5,  fishQualityScale = {'epic'},     sell = false, name = 'Triple Hook Bait', category = "baits", price = 60, stars = 5, baitsuse = true},


    --------------------------- RODS ------------------------                          sell = false  -- do not change
    {itemname = 'woodenrod',       minigameDiff = 'veryHard',  name = 'Wooden Rod',        sell = false, category = "rods", price = 300, stars = 1, minlevel = 30, use = true},
    {itemname = 'slimmaterialrod', minigameDiff = 'hard',      name = 'Slim Material Rod', sell = false, category = "rods", price = 500, stars = 2, minlevel = 40, use = true},
    {itemname = 'danishrod',       minigameDiff = 'medium',    name = 'Danish Rod',        sell = false, category = "rods", price = 1500, stars = 3, minlevel = 30, use = true},
    {itemname = 'koidrod',         minigameDiff = 'easy',      name = 'Koi Rod',           sell = false, category = "rods", price = 3000,stars = 4, minlevel = 40, use = true},
    {itemname = 'finewood',        minigameDiff = 'veryEasy',  name = 'Finewood Rod',      sell = false, category = "rods", price = 5000,stars = 5, minlevel = 50, use = true},
