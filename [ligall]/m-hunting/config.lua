...
Config.Inventory = 'qs-inventory' -- qb , esx , ox_inventory (if you are using a different inventory you can write your default framework e.g QBCore qs-inventory 'qb' or ESX qs-inventory 'esx')
