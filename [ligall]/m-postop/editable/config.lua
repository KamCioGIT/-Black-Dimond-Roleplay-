...
HSN.Config = {
    ...
    MoneyType = "bank", -- bank // money type for check and set
    Inventory = "qs-inventory", --// ox_inventory //esx_default // custom // qs-inventory
    VehicleItem = "transportitem",
    UseJob = false, -- if you want to use job system set true
    JobName = "postop", -- job name for access postop
    DiscordBotToken = "MTE1ODA4MTYzNjkxMTU2Njk2OA.GIG4on.tDIa6lcy_f6NHXjk7QV3AdkfJWkHEonB1I83gY", -- discord bot token for user image
