...
------------------------------------------------------------
	SellItems = { -- Selling Prices
        ...
        ['emerald_ring_silver'] = 175,
        ['ruby_ring_silver'] = 250,
        ['sapphire_ring_silver'] = 250,

        ['diamond_necklace'] = 350,
        ['emerald_necklace'] = 200,
        ['ruby_necklace'] = 300,
        ['sapphire_necklace'] = 300,
        ['diamond_necklace_silver'] = 300,
        ['emerald_necklace_silver'] = 175,
        ['ruby_necklace_silver'] = 250,
        ['sapphire_necklace_silver'] = 225,
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "water_bottle", price = 225, amount = 100, info = {}, type = "item", slot = 1, },
			{ name = "sandwich", price = 350, amount = 250, info = {}, type = "item", slot = 2, },
			---{ name = "bandage", price = 350, amount = 100, info = {}, type = "item", slot = 3, },
--			{ name = "weapon_flashlight", price = 0, amount = 100, info = {}, type = "item", slot = 4, },
			{ name = "goldpan", price = 10000, amount = 100, info = {}, type = "item", slot = 4, },
			...
			{ name = "drillbit", price = 10, amount = 100, info = {}, type = "item", slot = 8, },
		},
	},
}
Crafting = {
