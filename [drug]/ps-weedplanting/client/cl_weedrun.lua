...
local createNewDropOff = function()
    ...
    hasDropOff = true
    TriggerEvent('lb-phone:client:CustomNotification', _U('weedrun_delivery_title'), _U('weedrun_delivery_godropoff'), 'fas fa-cannabis', '#00FF00', 8000)
	...
	dropOffArea:onPlayerInOut(function(isPointInside, point)
		if isPointInside then
			if not deliveryPed then
				TriggerEvent('lb-phone:client:CustomNotification', _U('weedrun_delivery_title'), _U('weedrun_delivery_makedropoff'), 'fas fa-cannabis', '#00FF00', 8000)
...
RegisterNetEvent('ps-weedplanting:client:ClockIn', function()
    ...
    delivering = true
    TriggerEvent('lb-phone:client:CustomNotification', _U('weedrun_delivery_title'), _U('weedrun_delivery_waitfornew'), 'fas fa-cannabis', '#00FF00', 8000)
...
RegisterNetEvent('ps-weedplanting:client:DeliverWeed', function()
	...
	if #(GetEntityCoords(ped) - GetEntityCoords(deliveryPed)) < 5.0 then
		...
		dropOffArea:destroy()
		Wait(2000)
		TriggerEvent('lb-phone:client:CustomNotification', _U('weedrun_delivery_title'), _U('weedrun_delivery_success'), 'fas fa-cannabis', '#00FF00', 20000)
        ClearPedTasks(ped)
