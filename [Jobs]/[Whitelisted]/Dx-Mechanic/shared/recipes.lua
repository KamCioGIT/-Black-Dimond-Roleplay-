...
Stores = {
	ToolItems = {
		...
		items = {
			{ name = "mechanic_tools", price = 15, amount = 10, info = {}, type = "item", },
			{ name = "toolbox", price = 15, amount = 10, info = {}, type = "item", },
			{ name = "ducttape", price = 10, amount = 100, info = {}, type = "item", },
			{ name = "paintcan", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "tint_supplies", price = 100, amount = 50, info = {}, type = "item", },
			{ name = "underglow_controller", price = 200, amount = 50, info = {}, type = "item", },
			...
			{ name = "iron", price = 10, amount = 1000, info = {}, type = "item", },
		},
	},
	PerformItems = {
		label = Loc[Config.Lan]["stores"].perform,
		items = {
			{ name = "turbo", price = 14000, amount = 50, info = {}, type = "item", },
			...
			{ name = "engine5", price = 18000, amount = 50, info = {}, type = "item", },
			{ name = "transmission1", price = 3000, amount = 50, info = {}, type = "item", },
			{ name = "transmission2", price = 4500, amount = 50, info = {}, type = "item", },
			{ name = "transmission3", price = 6000, amount = 50, info = {}, type = "item", },
			{ name = "transmission4", price = 8000, amount = 50, info = {}, type = "item", },
			{ name = "brakes1", price = 2500, amount = 50, info = {}, type = "item", },
			{ name = "brakes2", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "brakes3", price = 6500, amount = 50, info = {}, type = "item", },
			{ name = "car_armor", price = 20000, amount = 50, info = {}, type = "item", },
			{ name = "suspension1", price = 3000, amount = 50, info = {}, type = "item", },
			{ name = "suspension2", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "suspension3", price = 4800, amount = 50, info = {}, type = "item", },
			{ name = "suspension4", price = 5500, amount = 50, info = {}, type = "item", },
			{ name = "suspension5", price = 7000, amount = 50, info = {}, type = "item", },
			--[[ { name = "bprooftires", price = 0, amount = 50, info = {}, type = "item", }, ]]
			-- { name = "drifttires", price = 3500, amount = 50, info = {}, type = "item", },
	...
	StoreItems = {
		...
		items = {
			{ name = "hood", price = 750, amount = 50, info = {}, type = "item", },
			{ name = "roof", price = 750, amount = 50, info = {}, type = "item", },
			{ name = "spoiler", price = 900, amount = 50, info = {}, type = "item", },
			{ name = "bumper", price = 1300, amount = 50, info = {}, type = "item", },
			{ name = "skirts", price = 300, amount = 50, info = {}, type = "item", },
			{ name = "exhaust", price = 750, amount = 50, info = {}, type = "item", },
			{ name = "seat", price = 80, amount = 50, info = {}, type = "item", },
			{ name = "livery", price = 5000, amount = 50, info = {}, type = "item", },
			{ name = "tires", price = 1300, amount = 50, info = {}, type = "item", },
			{ name = "horn", price = 250, amount = 50, info = {}, type = "item", },
			{ name = "internals", price = 150, amount = 50, info = {}, type = "item", },
			{ name = "externals", price = 150, amount = 50, info = {}, type = "item", },
			{ name = "customplate", price = 300, amount = 50, info = {}, type = "item", },
			{ name = "headlights", price = 700, amount = 50, info = {}, type = "item", },
			{ name = "rims", price = 2500, amount = 100, info = {}, type = "item", },
			{ name = "rollcage", price = 4500, amount = 50, info = {}, type = "item", },
