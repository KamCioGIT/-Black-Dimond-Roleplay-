...
Config.Locations = {
	...
	{	job = "mechanic",
		...
		manualRepair = { { coords = vec4(129.97116088867, -1110.6725585938, 29.195058822632, 0.92223143577576), prop = true, } },
	...
	{	job = "mechanicimp",
		zones = {
			vec2(847.51525878906, -942.98779296875),
			vec2(848.65411376953, -996.67553710938),
			vec2(800.37573242188, -999.7578125),
			vec2(794.75006103516, -990.92034912109),
			vec2(794.39147949219, -924.22894287109),
			vec2(800.95324707031, -922.21234130859),
			vec2(846.62524414062, -919.41851806641)
		},
		autoClock = { enter = true, exit = true, },
		stash = { { coords = vec4(828.99, -946.47, 22.09, 0.0), w = 2.8, d = 1.0, }, },
		store = { { coords = vector4(842.94, -981.57, 26.5, 72.78), w = 6.2, d = 2.4, }, },
		crafting = { { coords = vec4(843.16, -951.03, 26.5, 0.0), w = 4.8, d = 1.0, }, },
		clockin = { { coords = vec4(836.0, -933.18, 32.14, 157.0), prop = true }, },
		manualRepair = { { coords = vec4(808.85, -956.84, 22.11, 359.01), prop = true, } },
		garage = { spawn = vec4(812.17, -996.55, 26.27, 90.81),
					out = vec4(819.06, -994.42, 26.21, 183.08),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
					prop = true },
		payments = { coords = vector4(843.21, -986.33, 26.5, 265.8),
			img = "<center><p><img src=https://cdn.discordapp.com/attachments/1114458557883093022/1142139963970957463/Picsart_23-08-18_22-54-05-644.png width=150px></p>",
			prop = true, },
		blip = vec3(825.9, -964.08, 26.5),
		bliplabel = "Import Mechanic",
		blipcolor = 0,
		discordlink = "",
	...
	{	job = "mechanicls",
		...
		autoClock = { enter = true, exit = true, },
		stash = { { coords = vec4(-350.44, -132.11, 42.04, 162.55), w = 3.2, d = 1.0 }, },
		store = { { coords = vec4(-362.49597167969, -98.407241821289, 39.546619415283, 249.4010925293), w = 4.2, d = 3.6 }, },
		crafting = { { coords = vec4(-328.42184448242, -165.7989654541, 39.009510040283, 195.7785949707), w = 3.0, d = 1.2 }, },
		clockin = { { coords = vec4(-348.23, -130.22, 42.04, 341.41), prop = true, }, },
		manualRepair = { { coords = vec4(-341.30642700195, -164.86755371094, 39.009391784668, 340.96734619141), prop = true, } },
		garage = { spawn = vec4(-359.2473449707, -122.99184417725, 38.699180603027, 153.87454223633),
					out = vec4(-353.57632446289, -125.99276733398, 39.434448242188, 74.700416564941),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
					prop = true, },
		payments = { coords = vec4(-345.16, -128.24, 38.93, 65.46),
