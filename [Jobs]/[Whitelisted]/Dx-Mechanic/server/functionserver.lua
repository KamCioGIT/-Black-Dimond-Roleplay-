...
RegisterNetEvent('jim-mechanic:chargeCash', function(cost, society)
	QBCore.Functions.GetPlayer(source).Functions.RemoveMoney("cash", cost, "Mechanic Charge cash")
	...
	if Config.RenewedBanking then
		exports['codem-bank']:addAccountMoney(society, math.ceil(cost - (cost / 4)))
	else
