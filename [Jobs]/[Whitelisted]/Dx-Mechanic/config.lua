...
-- NOS STUFF
	...
	skillcheck = "dx-ui", -- When adding Nos to a vehicle there are three script options available
...
--Extra Vehicle Repair Costs
	...
	RepairBody = "iron",			---Body Repair item and its cost
	RepairBodyCost = 1,
...
--DuctTape Controllers
	...
	JobRoles = { "mechanic", "mechanicls", "mechanicimp", "mechanictuner" }, -- These are the job roles who can use items if RequiresJob is enabled.
