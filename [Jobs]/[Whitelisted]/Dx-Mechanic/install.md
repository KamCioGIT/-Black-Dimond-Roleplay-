...
## 2.9.6:
    - Initial support for lb-phone with preview emails - preview.lua
...
## Update v2.5:
	...
	- Added support for toggling between gks-phone and lb-phone for the preview emails in the config
