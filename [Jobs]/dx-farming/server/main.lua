...
AddEventHandler('osm-farming:GivePlayerBox', function()
	...
	Player.Functions.AddItem('box', 1) ---- change this shit 
...
AddEventHandler('osm-farming:CowMilked', function()
	...
	local Player = QBCore.Functions.GetPlayer(src)
	  ...
	  if TriggerClientEvent("QBCore:Notify", src, "You got some Milk!") then
	...
	print('wow')
		...
		if item ~= nil then 
			if item.amount > 10 then 
				Player.Functions.RemoveItem('apple', math.random(5,10))----change this
				Player.Functions.RemoveItem('box', 1)----change this
				...
				TriggerClientEvent('QBCore:Notify', src, 'You need atleast 10 Apples!', "success")   
			end     
		else    
			TriggerClientEvent('QBCore:Notify', src, 'You need atleast 10 Apples!', "success")   
		end                                                                				
...
AddEventHandler('osm-farming:GiveOranges', function()
		local src = source
    	local Player = QBCore.Functions.GetPlayer(src)
		Player.Functions.AddItem('apple', math.random(4, 7))----change this
		TriggerClientEvent('QBCore:Notify', src, 'You got a few Apples from the Tree!', "success")                                                                         				
end)
