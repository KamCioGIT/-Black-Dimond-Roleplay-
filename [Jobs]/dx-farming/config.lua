...
Config.SellLocation =  {x = 163.925, y = 6633.044, z = 31.111}
...
Config.MilkOutput = math.random(4,6)
...
Config.CircleZones = {
	...
	OrangePack = {coords = vector3(2197.1828613281,5603.3310546875,53.513450622559), name = 'blip_478', color = 0, sprite = 6, radius = 10.0},
	MilkPack = {coords = vector3(2198.8520507812,5609.2216796875,53.442737579346), name = 'blip_478', color = 0, sprite = 6, radius = 10.0},
	Boxes = {coords = vector3(2192.2998046875,5594.560546875,53.768180847168), name = 'blip_478', color = 0, sprite = 6, radius = 10.0},
	CornProcessing = {coords = vector3(2196.0209960938, 5594.4755859375, 53.773300170898), name = 'blip_478', color = 0, sprite = 6, radius = 10.0},
...
Config.ItemList = {
    ["orange"] = math.random(40, 60),
	["apple"] = math.random(40, 60),
    ["milk"] = math.random(60, 85),
	["corn_kernel"] = math.random(15, 20),
    ["corn_packet"] = math.random(250, 400),
    ["milk_pack"] = math.random(300, 425),
	["fruit_pack"] = math.random(200, 400),
	["grapejuice"] = math.random(200, 300),
	["wine"] = math.random(250, 500),
	["packedbeef"] = math.random(750, 900),
	["packedpig"] = math.random(850, 1000)
}

Config.Blips = {
   	{title="Cow Farm", colour=16, id=141, x = 2478.392578125, y = 4728.8315429688, z = 34.303840637207},
	{title="Corn Farm Supply", colour=16, id=478, x = 2041.5297851562, y = 4854.5625, z= 43.097927093506},
	{title="Braddock Farm", colour=16, id=88, x = 2195.4331054688, y = 5602.6352539062, z = 53.584144592285},
	{title="Apple Farm", colour=17, id=486, x = 346.62341308594, y = 6522.9448242188, z = 28.830759048462},
	{title="Don's Country Shop", colour=25, id=434, x = 163.925, y = 6633.044, z = 31.1112},
}
