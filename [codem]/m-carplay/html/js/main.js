    ...
    data: () => ({
        ...
        PlayerPlaylist : [
            {title : 'Liked Songs', song : [{
                ...
                kapakPictures : 'https://i.scdn.co/image/ab67616d0000b273baf89eb11ec7c657805d2da0',
                songimage : 'https://i.scdn.co/image/ab67616d00001e02baf89eb11ec7c657805d2da0',
                image : 'https://i.scdn.co/image/ab67616d00004851baf89eb11ec7c657805d2da0',
                liked : true,
                playing : false,
        ...
        Playlist : {
            ...
            Playingsong : {
                ...
                url : localStorage.getItem('playlistUrl') || 'https://youtu.be/dQw4w9WgXcQ',
                kapakPictures : localStorage.getItem('playlistKapakPictures') || 'https://i.scdn.co/image/ab67616d0000b273baf89eb11ec7c657805d2da0',
                songimage :  localStorage.getItem('playlistSongimage') ||'https://i.scdn.co/image/ab67616d00001e02baf89eb11ec7c657805d2da0',
                image :  localStorage.getItem('playlistImage') ||'https://i.scdn.co/image/ab67616d00004851baf89eb11ec7c657805d2da0',
                ...
                if (this.Playlist.OtherPlayer == true) {
                    ...
                    $.getJSON('https://noembed.com/embed?url=', { format: 'json', url: this.Playlist.SongURLvmodel }, (data) => {
                        ...
                        if (!this.SpotifyImage) {
                            ...
                            localStorage.setItem('playlistArtistname', this.Playlist.Playingsong.artistname);
                            localStorage.setItem('playlistKapakPictures', this.Playlist.Playingsong.kapakPictures);
                            localStorage.setItem('playlistSongimage', this.Playlist.Playingsong.songimage);
