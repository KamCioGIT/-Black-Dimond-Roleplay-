...
function FormatQBCoreData(data)
    return {
        ...
        face_md_weight = data.facemix and (tonumber(data.facemix.shapeMix) == nil and 50 or tonumber(data.facemix.shapeMix))  or 50,
        skin_md_weight = data.facemix and  (tonumber(data.facemix.skinMix) == nil and 50 or tonumber(data.facemix.skinMix)) or 50,
        ...
        blemishes_1 = data.blemishes and (tonumber(data.blemishes.item) == nil and 0 or tonumber(data.blemishes.item)) or 0,
        blemishes_2 = data.blemishes and (tonumber(data.blemishes.texture) == nil and 0 or tonumber(data.blemishes.texture)) or 0,
        chest_1 = data.chest and (tonumber(data.chest.item) == nil and 0 or tonumber(data.chest.item)) or 0,
        chest_2 = data.chest_thickness and (tonumber(data.chest_thickness.item) == nil and 0 or tonumber(data.chest_thickness.item)) or 0,
        chest_3 = data.chest and (tonumber(data.chest.texture) == nil and 0 or tonumber(data.chest.texture)) or 0,
        bodyb_1 = data.body_blemishes and (tonumber(data.body_blemishes.item) == nil and 0 or tonumber(data.body_blemishes.item)) or 0,
        bodyb_2 = data.body_blemishes and (tonumber(data.body_blemishes.texture) == nil and 0 or tonumber(data.body_blemishes.texture)) or 0,
        bodyb_3 = data.body_blemishes_2 and  (tonumber(data.body_blemishes_2.item) == nil and 0 or tonumber(data.body_blemishes_2.item))  or 0,
        bodyb_4 = data.body_blemishes_2 and (tonumber(data.body_blemishes_2.texture) == nil and 0 or tonumber(data.body_blemishes_2.texture))  or 0,
        ...
        chin_1 = data.chimp_bone_lowering and (tonumber(data.chimp_bone_lowering.item) == nil and 0 or tonumber(data.chimp_bone_lowering.item)) or 0,
        chin_2 = data.chimp_bone_lenght and (tonumber(data.chimp_bone_lenght.item) == nil and 0 or tonumber(data.chimp_bone_lenght.item)) or 0,
        chin_3 = data.chimp_bone_width and (tonumber(data.chimp_bone_width.item) == nil and 0 or tonumber(data.chimp_bone_width.item))  or 0,
        ...
        complexion_1 = data.complexion and (tonumber(data.complexion.item) == nil and 0 or tonumber(data.complexion.item))  or 0,
        complexion_2 = data.complexion and (tonumber(data.complexion.texture) == nil and 0 or tonumber(data.complexion.texture)) or 0,
        eyebrows_1 = data.eyebrows and (tonumber(data.eyebrows.item) == nil and 0 or tonumber(data.eyebrows.item))  or 0,
        eyebrows_2 = data.eyebrows_2 and (tonumber(data.eyebrows_2.item) == nil and 0 or tonumber(data.eyebrows_2.item))  or 0,
        eyebrows_3 = data.eyebrows and (tonumber(data.eyebrows.texture) == nil and 0 or tonumber(data.eyebrows.texture))  or 0,
        eyebrows_5 = data.eyebrown_high and (tonumber(data.eyebrown_high.item) == nil and 0 or tonumber(data.eyebrown_high.item))  or 0,
        eyebrows_6 = data.eyebrown_forward and (tonumber(data.eyebrown_forward.item) == nil and 0 or tonumber(data.eyebrown_forward.item)) or 0,
        bracelets_1 = data.bracelet ~= nil and (tonumber(data.bracelet.item) == nil and -1 or tonumber(data.bracelet.item)) or -1, 
        bracelets_2 = data.bracelet and (tonumber(data.bracelet.texture) == nil and 0 or tonumber(data.bracelet.texture)) or 0,
        jaw_1 = data.jaw_bone_width and (tonumber(data.jaw_bone_width.item) == nil and 0 or tonumber(data.jaw_bone_width.item))  or 0,
        jaw_2 = data.jaw_bone_back_lenght and (tonumber(data.jaw_bone_back_lenght.item) == nil and 0 or tonumber(data.jaw_bone_back_lenght.item))  or 0,
        ...
        eye_squint = data.eye_opening and  (tonumber(data.eye_opening.item) == nil and 0 or tonumber(data.eye_opening.item)) or 0,
        chain_1 = data.accessory and (tonumber(data.accessory.item) == nil and 0 or tonumber(data.accessory.item))  or 0,
        chain_2 = data.accessory and (tonumber(data.accessory.texture) == nil and 0 or tonumber(data.accessory.texture))  or 0,
        ...
        tshirt_1 = data["t-shirt"] and (tonumber(data["t-shirt"].item ) == nil and 0 or tonumber(data["t-shirt"].item ))  or 0,
        tshirt_2 = data["t-shirt"] and (tonumber(data["t-shirt"].texture ) == nil and 0 or tonumber(data["t-shirt"].texture ))  or 0,
        ...
        lipstick_2 = data.lipstick_thickness and (tonumber(data.lipstick_thickness.item) == nil and 0 or tonumber(data.lipstick_thickness.item))  or 0,
        lipstick_3 = data.lipstick and (tonumber(data.lipstick.texture) == nil and 0 or tonumber(data.lipstick.texture)) or 0,
        lipstick_4 = 0,
        makeup_1 = data.makeup ~= nil and (tonumber(data.makeup.item) == nil and 0 or tonumber(data.makeup.item)) or 0,
        makeup_2 = data.makeup ~= nil and (tonumber(data.makeup.texture) == nil and 0 or tonumber(data.makeup.texture)) or 0,
        makeup_3 =  data.makeup_2 ~= nil and (tonumber(data.makeup_2.item) == nil and 0 or tonumber(data.makeup_2.item)) or 0,
        makeup_4 = data.makeup_2 ~= nil and (tonumber(data.makeup_2.texture) == nil and 0 or tonumber(data.makeup_2.texture)) or 0,
        ...
        hair_color_1 = data.hair_color_1 and  (tonumber(data.hair_color_1.item) == nil and 0 or tonumber(data.hair_color_1.item))   or 0,
        hair_color_2 = data.hair_color_2 and (tonumber(data.hair_color_2.item) == nil and 0 or tonumber(data.hair_color_2.item))   or 0,
        lip_thickness = data.lips_thickness and (tonumber(data.lips_thickness.item) == nil and 0 or tonumber(data.lips_thickness.item))  or 0,
        blush_1 = data.blush and  (tonumber(data.blush.item) == nil and 0 or tonumber(data.blush.item))  or 0,
        blush_2 = data.blush_thickness and (tonumber(data.blush_thickness.item) == nil and 0 or tonumber(data.blush_thickness.item))   or 0,
        blush_3 = data.blush and (tonumber(data.blush.texture) == nil and 0 or tonumber(data.blush.texture))  or 0,
        neck_thickness = data.neck_thikness and (tonumber(data.neck_thikness.item) == nil and 0 or tonumber(data.neck_thikness.item)) or 0,
