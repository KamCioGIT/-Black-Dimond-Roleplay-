...
Config.Nui = {
    key = "TAB", text = "Open Inventory", command = "openinventory"
}
Config.Hotbar = {
    enable = true, text = "Inventory Hotbar", command = "invhotbar", key = "Z"
}

Config.InteractionType = "qb-target" -- drawtext -- qb-target
